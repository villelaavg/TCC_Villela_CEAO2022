...
for i in range(limite):
    ...
    #Juntando datasets
    dataset = junta_3_dataset(df_sup, df, df_inf)
    ...
    m.scatter(dataset['lon'], dataset['lat'], s=10, c='blue', alpha=1, zorder=2)
...
for i in range(len(df_sar)):
    ...
    caminhos = pd.read_excel('dados_rotas_7nm_21jun.xlsx', sheet_name='caminhos')
    ...
    lista_repos = calculo_reposicionamento(dataset=caminhos, fator_antecipacao=2, fator_reposicionamento=10, fator_regresso=6)
